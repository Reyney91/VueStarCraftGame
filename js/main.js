  ...
  methods: {
    ...
    endGame() {
      ...
      if (
        ...
        this.score.primal < 8 &&
        Math.abs(this.score.zerg - this.score.protoss) > 3
      ) {
      ...
      //Гибрид
      else if (Math.abs(this.score.zerg - this.score.protoss) <= 3) {
